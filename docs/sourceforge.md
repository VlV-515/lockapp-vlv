...
- Remote folder: `/home/frs/project/lockapp-vlv/v1.2.0`.

## Prepare Local Mirror Folder

```bash
./scripts/prepare-sourceforge-release.sh 1.2.0
```

Expected folder:

```text
dist/sourceforge/v1.2.0/
```
...
```bash
./scripts/publish-sourceforge.sh 1.2.0 vlv lockapp-vlv
```
